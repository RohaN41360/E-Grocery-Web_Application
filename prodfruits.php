...
<html>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
      ...
      <li class="nav-item">
        ...
        <div class="dropdown">
    <button class="btn btn-default dropdown-toggle btn-in" type="button" data-toggle="dropdown">Friuts
      ...
      <li><a href="prodfruits.php">Fruits</a></li>
        ...
        <div class="container">
            ...
            <div class="row mt-2 pb-3">
                ...
                $stmt = $conn->prepare("select * from products where product_code like 'f_%' ");
              $stmt->execute();
